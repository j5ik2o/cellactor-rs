...
//! Cluster identity lookup, placement, and routing primitives for the fraktor runtime.

extern crate alloc;

/// Core no_std friendly building blocks for cluster identity services.
pub mod core;
/// std-only helpers, metrics exporters, and integration glue.
